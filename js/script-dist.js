...
var AudioController = /*#__PURE__*/function () {
  function AudioController() {
    ...
    new Audio("!source/sound/ls-on-1.mp3"), new Audio("!source/sound/ls-on-2.mp3"), new Audio("!source/sound/ls-on-3.mp3")];
    this.matched = [1, //iterator
    new Audio("!source/sound/hit-1.mp3"), new Audio("!source/sound/hit-2.mp3"), new Audio("!source/sound/hit-3.mp3")];
    this.unmatched = [1, //iterator
    new Audio("!source/sound/mis-1.mp3"), new Audio("!source/sound/mis-2.mp3")];
